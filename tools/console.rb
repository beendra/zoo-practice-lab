...
animal1 = Animal.new("tigger", "tiger", "Lincoln Park Zoo")
animal2 = Animal.new("simba", "lion", "zoo1")
animal3 = Animal.new("bob", "monkey", "Lincoln Park Zoo")
animal4 = Animal.new("rafiki", "baboon", "zoo1")
